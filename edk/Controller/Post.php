...
class Post extends Base
{
	...
	public function indexAction()
	{
		...
		$smarty->assign('isadmin', $this->page->isAdmin());
		...
		$this->page->setContent($smarty->fetch(get_tpl('post')));
		$this->page->generate();
	}
	...
	<input id="submit" name="submit" type="submit" value="Undelete" />
				...
				header("Location: ".html_entity_decode(\EDK\Core\EDK::urlFor('KillDetail:index', ['id' => $killid])));
				exit;
			}
		} else {
