...
class Troubleshooting extends Base
{
	function indexAction()
	{
		...
		$cachingFolderApi = KB_CACHEDIR. DIRECTORY_SEPARATOR . "api";
		...
		$cachingFolderSql = KB_QUERYCACHEDIR;
		...
		$cachingFolderObject = KB_CACHEDIR. DIRECTORY_SEPARATOR . "store";
