Please select pilots, corps or alliances to be exported.
<br />
<br />
<form id="search" action="{$kb_host}/admin_kill_export" method="post">
...
{if $permissions}
<br/>
<a href="{$kb_host}/?a=admin_kill_export&sub=do">Export Mails</a>
{/if}
<br/>
